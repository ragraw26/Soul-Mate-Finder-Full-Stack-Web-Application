 ...
 %> 
	...
	<section id="main-content">
          <section class="wrapper site-min-height">
            <div class="row">
              <div id="searchArea" class="col-lg-9 well">
          	
			<c:forEach var="user" items="${userList}">
              <div class="row mtpost">
                <div class="form-panel">
                  <form:form method="POST" action="unFriend">
                        <a href="profile?userId=${user.getUserId()}"><h3><i class="fa fa-angle-right"></i> <img onerror="this.src='resources/img/default.jpg';" src="${user.getFileLocation()}" width=150 height=150 class="img-circle" />
                        ${user.getUserfullName()}</a>
                        <button type="submit" class="pull-right btn btn-danger btn-sm">Remove Contact</button>&nbsp;&nbsp;&nbsp;
                        <input type="hidden" name="userId" value="${user.getUserId()}" />
                        &nbsp;&nbsp;&nbsp;
                        <a href="getMessage?userId=${user.getUserId()}" class="pull-right btn btn-warning btn-sm">Send Message</a></h3>&nbsp;&nbsp;&nbsp;
                  </form:form>                  
                </div>
              </div>
			</c:forEach>
