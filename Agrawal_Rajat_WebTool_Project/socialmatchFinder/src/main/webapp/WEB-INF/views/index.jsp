											...
											<form:form class="form-horizontal tasi-form"
												...
												<div class="form-group">
													<textarea class="form-control form-post" name="status"
														id="status" placeholder="Interest your buddies" required="required"></textarea>
												</div>
									...
									<c:forEach var="post" items="${posts}">
										<div class="col-md-12 well">
											<div class="form-panel">
												<h4>
												<a href="#"><img
													onerror="this.src='${pageContext.servletContext.contextPath}/resources/img/default.jpg';"
													src="${post.getUserstable().getFileLocation()}" width=40px
													class="img-circle pull-left" />
													&nbsp; ${post.getUserstable().getUserfullName()}</a>
												</h4>
												<br />
												<p>
												...
												<div class="postEnd commentSection">
													<c:forEach var="comment" items="${post.getComments()}">
													 <b> <a href="myProfile?userId=${comment.getUserstable().getUserId()}"><img onerror="this.src='resources/img/default.jpg';" src="${comment.getUserstable().getFileLocation()}" width=20px class="img-circle pull-left" />
	                     &nbsp; ${comment.getUserstable().getUserfullName()}</a></b>
													&nbsp;${comment.getComment()}
													<br/>
													<br/>
													</c:forEach>
												...
												<div class="form-group">
	                              <input type="text" autocomplete="off" class="form-control form-post comment" name="comment" placeholder="Comment"  required="required"/>
	                          </div>
	...
	<!----Modal End--->
		...
		<!---Modal for Forum---->
						...
						<script class="include" type="text/javascript"
							src="${pageContext.servletContext.contextPath}/resources/assets/js/jquery.dcjqaccordion.2.7.js"></script>
						<script src="resources/js/jquery.scrollTo.min.js"></script>
						<script src="${pageContext.servletContext.contextPath}/resources/js/jquery.nicescroll.js"
							type="text/javascript"></script>
						<script src="${pageContext.servletContext.contextPath}/resources/js/jquery.sparkline.js"></script>


						<!--common script for all pages-->
						<script src="${pageContext.servletContext.contextPath}/resources/assets/js/common-scripts.js"></script>
